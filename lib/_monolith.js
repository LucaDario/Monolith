...
WidgetResolver = {
    widgets: {
        ...
        checklist: () => {
            ...
            let opt2 = new CheckOption();
            opt.setText('CIAO');
            opt2.setText('VEZ');
            opt2.setChecked(true);
            test.addOption(opt,function(){},function(){});
            test.addOption(opt2,function(){},function(){});
            vl2.addItem(test);

            let test2 = new ChecklistWidget();
            test2.setSelectionColor('#0f0');
            test2.setUseSelectionMark(false);
            let opt3 = new CheckOption();
            let opt4 = new CheckOption();
            opt3.setText('MARTEI!');
            opt4.setText('VEZ');
            opt3.setChecked(true);
            test2.addOption(opt3,function(){},function(){});
            test2.addOption(opt4,function(){},function(){});
            vl2.addItem(test2);
