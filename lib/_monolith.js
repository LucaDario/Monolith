...
import {ChecklistWidgetItem} from '../client/component/widget/checklist/view/ChecklistWidgetItem';
...
Monolith.widgets = {
    ...
    checklist : {
        ChecklistWidgetItem:  ChecklistWidgetItem,
...
Monolith.bubble = {
    ...
    bubbles: {
        ...
        todo: () =>{
            ...
            test.setOnLongClick(function(index){
