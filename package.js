...
Package.onUse(function(api) {
    ...
    api.addFiles([
        ...
        'client/component/widget/checklist/presenter/ChecklistWidgetItemPresenter.js',
        'client/component/widget/checklist/style/CheckStyle.js',
        'client/component/widget/checklist/view/ChecklistWidgetItem.js',
        'client/component/widget/checklist/ChecklistWidgetItemView.js',
...
Package.onTest(function(api) {
    ...
    api.addFiles([
        ...
        'client/component/widget/checklist/ChecklistWidgetItemView.test.js',
        'client/component/widget/checklist/view/ChecklistWidgetItem.test.js',
